                ...
                <TableCell colSpan={5} className="h-64 text-center">
                  <div className="flex flex-col items-center justify-center text-slate-400">
                    ...
                    <p className="text-lg font-medium text-slate-600 mb-1">
                      No Liquidated request yet
                    </p>
                    <p className="text-sm">
                      Review RFP requests and submit your first Liquidation request to
                      begin managing your Liquidated requests
                    </p>
                  </div>
                </TableCell>
              </TableRow>
